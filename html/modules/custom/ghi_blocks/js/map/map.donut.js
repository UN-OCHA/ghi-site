(function ($) {
  ...
  Drupal.hpc_map_donut.createLocations = function(data, sel, proj) {
    ...
    for (i = 0; i < data.length; i++) {
      ...
      let r = object[state.index][primary_key] > 0 ? Drupal.hpc_map.getRadius(object, 1, base_radius, state, object.radius_factor / scale, min_radius / Math.sqrt(scale)) : min_radius;

...
class ConfigurationContainerItemManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/ConfigurationContainerItem', $namespaces, $module_handler, 'Drupal\ghi_form_elements\ConfigurationContainerItemPluginInterface', 'Drupal\ghi_form_elements\Attribute\ConfigurationContainerItem');

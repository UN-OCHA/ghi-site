...
namespace Drupal\cd_views_grid\Plugin\views\style;
 ...
 * @ViewsStyle(
 *   id = "cd_grid",
 *   title = @Translation("CD Grid"),
 *   help = @Translation("A responsive grid."),
 *   theme = "views_view_cd_grid",
 *   display_types = {"normal"}
 * )
 */
class CdViewsGrid extends StylePluginBase {

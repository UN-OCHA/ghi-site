 ...
 * @RemoteSource(
 *   id = "gho_2021",
 *   label = @Translation("GHO 2021"),
 *   description = @Translation("Import data directly from the GHO 2021 website."),
 * )
 */
class Gho2021 extends RemoteSourceBase implements RemoteSourceInterface {

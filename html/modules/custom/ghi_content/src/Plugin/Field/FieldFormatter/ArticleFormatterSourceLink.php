 ...
 * )
 */
class ArticleFormatterSourceLink extends ArticleFormatter implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $remote_url = $remote_source_instance->getContentUrl($article_id, !$this->getSetting('link_to_edit') ? 'canonical' : 'edit');

 ...
 *
 * @FieldFormatter(
 *   id = "ghi_remote_document_source_link",
 *   label = @Translation("Source link"),
 *   field_types = {"ghi_remote_document"}
 * )
 */
class DocumentFormatterSourceLink extends DocumentFormatter implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $remote_url = $remote_source_instance->getContentUrl($document_id, !$this->getSetting('link_to_edit') ? 'canonical' : 'edit');
